  ...
  render() {
    const movieItems = this.props.movies.map(movie => (
      <div key={movie.imdbID}>
            <button type="button" className="btn btn-link" id="searchId" value={movie.imdbID} onClick={this.showDetails}>
                  {movie.Title}
            </button>
            ...
            <div className="container">
                  <div className="jumbotron">
                        ...
                        <form id="searchForm" onSubmit={this.onSubmit}>
                              <input type="text" className="form-control" id="searchText" placeholder="Search Movies..." onChange={this.onChange} value={this.state.searchText} />
                              <br />
                              <button type="submit">
                                    Submit
                              </button>
